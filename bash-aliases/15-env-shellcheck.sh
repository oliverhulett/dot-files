...
SHELLCHECK_OPTS+=' -e SC1107'	## This directive is unknown.  It will be ignored.
SHELLCHECK_OPTS+=' -e SC1125'	## Invalid key=value pair? Ignoring the rest of this directive starting here.
